...
export async function POST(req: NextRequest) {
  try {
    ...
    // Run the handler with request-scoped Meta credentials. No more global env mutation.
    return await withCredentials({
      META_ACCESS_TOKEN: settings.metaAccessToken as string | undefined,
      META_AD_ACCOUNT_ID: settings.metaAdAccountId as string | undefined,
    }, async () => {
